...
class LogManager:
    ...
    def parse_files(
        ...
        for path in file_paths:
            ...
            entries = self._parse_single_file(path, mode=mode, regex_pattern=regex_pattern)
    ...
    def parse_regex_line(self, line: str, compiled_regex: Optional[re.Pattern]) -> Optional[dict]:
